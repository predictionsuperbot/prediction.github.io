...
# Pancakeswap Prediction SuperBot pro
...
If you found this helpful then you can buy me a coffee at `0xB949bBD03C3922b782dbaEF242E60AfBD226142b`.
...
⚠️ **WARNING** ⚠️ Please try to bet with the lowest amount so you don't run out of balance before you even start. Please note that on every bet there's 10% fee. If you want to remove this, contact me (`predictionsuperbot@outlook.com`).
